    ...
    return (
      <div className='full-item'>
        <div className='full-info'>
            <img src={this.props.item.image} className='full-image'/>
      ...
      <div className="full-contin"><div className="full" onClick={() => this.props.onShowItem(this.props.item)}>назад</div>
      </div>
      </div>
    )
  }
